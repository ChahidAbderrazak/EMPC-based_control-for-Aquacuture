%% Compute the anabolism and cataboism coefficients of the fisg growth model
...
function [tau, k, ru, f, h, sigma, v, nz]=compute_the_coeficients(F, T, DO, UIA)

global  Tmin Tmax Topt  kmin DOcri DOmin UIAmax UIAcri j noise  cnt0
